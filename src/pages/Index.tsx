...
const faqItems = [
  {
    q: "Чем отличается Бюджетный ПК от Народного игрового?",
    a: "Бюджетный (от 40 000 ₽) основан на Ryzen 5 5600G со встроенной графикой Radeon Vega 7 — подходит для офиса, учёбы и интернета без дискретной видеокарты. Народный игровой (от 100 000 ₽) оснащён дискретной RTX 4060 Ti 16 ГБ и тянет современные игры на высоких настройках.",
  },
  {
    q: "Подойдёт ли сборка «Рабочий» для видеомонтажа?",
    a: "Да. Intel Core i5-13500 и 64 ГБ оперативной памяти обеспечивают комфортную работу в Premiere Pro, DaVinci Resolve и других редакторах. Два накопителя (1 ТБ под систему + 2 ТБ под проекты) позволяют хранить большие медиафайлы без тормозов.",
  },
  {
    q: "Можно ли добавить дискретную видеокарту в Бюджетный ПК позже?",
    a: "Да, материнская плата MSI B450M-A Pro Max 2 имеет слот PCIe для видеокарты. При апгрейде может потребоваться замена блока питания на более мощный.",
  },
  {
    q: "Почему в «Рабочем» ПК нет дискретной видеокарты?",
    a: "Для разработки и дизайна (код, Figma, браузер, виртуальные машины) встроенная Intel UHD Graphics 770 полностью достаточна. Бюджет вложен в более важные для этих задач компоненты: мощный процессор и большой объём ОЗУ.",
  },
  {
    q: "Можно ли изменить комплектующие в любой сборке?",
    a: "Да, каждая сборка гибко настраивается под ваши задачи и бюджет. Напишите нам — подберём альтернативы или предложим апгрейд отдельных компонентов.",
  },
];
